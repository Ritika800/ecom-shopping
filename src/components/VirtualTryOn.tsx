...
import { User, Shirt, Palette, RotateCcw } from 'lucide-react';
      ...
      <DialogContent className="max-w-6xl h-[80vh] bg-white dark:bg-slate-900">
        <DialogHeader>
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Create your personalized 3D avatar and try on clothes virtually
          </p>
        </DialogHeader>
            ...
            <Card className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 border-blue-200 dark:border-blue-800">
              <CardContent className="p-4">
                ...
                <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
                  <li>• Customize your avatar to match your body type</li>
                  <li>• Try on different clothing items</li>
                  <li>• Rotate and zoom to see all angles</li>
